...
const linksGitHubPages = [
    { url: "https://marinap-prog.github.io/reusable-ui-components/", text: "See on GitHub Pages"},
    { url: "https://marinap-prog.github.io/habit-tracker/", text: "See on GitHub Pages"},
    { url: "https://marinap-prog.github.io/webFiktivniFirmy/", text: "See on GitHub Pages"},
    { url: "https://marinap-prog.github.io/formJS/", text: "See on GitHub Pages"},
...
linksGitHubPages.forEach((linkData, index) => {
    if (index < containers.length) {
        const targetContainer = containers[index];
        targetContainer.appendChild(createGitLink(linksGitHubPages.url, linksGitHubPages.text));
    }
});
